  ...
  return (
    <div className={`wrapper${sidebarOpen ? " shifted" : ""}`}>
      ...
      <section className="brandcard">
        <header className="brandcard__header">
          <h2 className="brandcard__title">
            ລາຍການ <span className="muted">(ເຫັນ {rows.length} ລາຍການ)</span>
          </h2>
          <div className="brand-actions-stack">
            <button className="fab fab--secondary" onClick={() => navigate("/branddelete")}>
              <IoTimeOutline className="fab__icon" /><span className="fab__label">ທີ່ຖືກລົບ</span>
            </button>
            <button className="fab fab--primary" onClick={() => navigate("/brandincrease")}>
